...
export default function Login() {
  ...
  const [form, setForm] = useState({ email: "", password: "", invitationCode: "" });
      ...
      <aside className="login-left" aria-label="Branding">
        ...
        <div className="login-left-content">
          ...
          <div className="login-left-copy">
            <h1 className="login-left-heading">Grow your MSME<br />sustainably</h1>
        ...
        <div className="login-right-inner">
          <div className="login-card fade-in-scale">
            ...
            <div className="login-card-header">
              ...
              <p className="login-subtitle">Log in or create an account to continue.</p>
            </div>

            <div className="login-tabs" role="tablist">
              <button role="tab" aria-selected="true"
                className="login-tab login-tab--active" type="button">
                Log In
              </button>
              <button role="tab" aria-selected="false"
                className="login-tab" type="button"
            ...
            <form className="login-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="form-field">
                ...
                <div className="input-wrapper">
                  ...
                  <button type="button" className="input-toggle-password"
              ...
              <div className="form-field">
                <div className="form-label-row">
                  <label className="form-label" htmlFor="login-code">Invitation Code</label>
                  <span className="form-label-badge">Optional</span>
                </div>
                <div className="input-wrapper">
                  <span className="input-icon"><IconTicket /></span>
                  <input id="login-code" name="invitationCode" type="text"
                    className="form-input" placeholder="e.g. REKAPIN-2024"
                    value={form.invitationCode} onChange={handleChange}
                    autoComplete="off" />
                </div>
              </div>
              ...
              <button type="submit" className="btn-primary-full"
                ...
                {isSubmitting ? (
                  <><span className="spinner spinner-sm" aria-hidden="true" /> Masuk...</>
                ) : (
                  <>Continue <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
            ...
            <p className="login-legal">
              ...
              <button type="button" className="link-subtle link-subtle--bold">Terms of Service</button>
              {" "}and{" "}
              <button type="button" className="link-subtle link-subtle--bold">Privacy Policy</button>.
            </p>
